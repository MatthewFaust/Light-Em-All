...
interface ILoWord {
  ...
  //returns an integer based on where the active word is or if there is none the middle of the screen
  int activeListX() ;
...
class MtLoWord implements ILoWord {
   ...
   * METHODS OF FIELDS
   * ... this.rest.checkAndReduce() ... -- ILoWord
...
class ZTypeWorld extends World {
  ...
  public WorldScene makeScene() {
    ...
    WorldScene scene = this.levelWorldScene().placeImageXY(new EquilateralTriangleImage(15,
        OutlineMode.OUTLINE, Color.red), this.words.activeListX(), 590).placeImageXY(new EquilateralTriangleImage(13,
  ...
  public World onTick() {
    ...
    if (this.ticks % this.levelChecker() == 0) {
      ...
      IWord newWord = new InactiveWord(new Utils(rand).callAcc(), (this.rand2.nextInt(300)) + 50, 0);
  ...
  public IWord levelFinder() {
    if (this.score < 100) { return new LevelWord("LEVEL 1", 300, 500, 1.5) ;} 
    if (this.score < 200) { return new LevelWord("LEVEL 2", 300, 500, 1.5) ;} 
    if (this.score < 300) { return new LevelWord("LEVEL 3", 300, 500, 1.5) ;} 
    if (this.score < 400) { return new LevelWord("LEVEL 4", 300, 500, 1.5) ;} 
    if (this.score < 500) { return new LevelWord("LEVEL 5", 300, 500, 1.5) ;} 
    if (this.score < 600) { return new LevelWord("LEVEL 6", 300, 500, 1.5) ;} 
    if (this.score < 700) { return new LevelWord("LEVEL 7", 300, 500, 1.5) ;} 
    if (this.score < 800) { return new LevelWord("LEVEL 8", 300, 500, 1.5) ;} 
    if (this.score < 900) { return new LevelWord("LEVEL 9", 300, 500, 1.5) ;} 
    else { return new LevelWord("FINAL LEVEL", 300, 500, 1.5) ;} 

  }

  public WorldScene levelWorldScene() {
    if (this.score < 100) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.white), 200, 300);} 
    if (this.score < 200) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.yellow), 200, 300);} 
    if (this.score < 300) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.yellow), 200, 300);} 
    if (this.score < 400) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.cyan), 200, 300);} 
    if (this.score < 500) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.cyan), 200, 300);} 
    if (this.score < 600) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.blue), 200, 300);} 
    if (this.score < 700) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.blue), 200, 300);} 
    if (this.score < 800) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.red), 200, 300);} 
    if (this.score < 900) { return new WorldScene(400, 600).placeImageXY(
        new RectangleImage(400, 600, OutlineMode.SOLID, Color.red), 200, 300);} 
    else { return new WorldScene(400, 600).placeImageXY(
  ...
  public int levelChecker() {
    ...
    if (this.score < 200) { return 90 ; } 
    if (this.score < 300) { return 80 ; } 
    if (this.score < 400) { return 70 ; } 
    if (this.score < 500) { return 60 ; } 
    if (this.score < 600) { return 50 ; } 
    if (this.score < 700) { return 45 ; } 
    if (this.score < 800) { return 40 ; } 
    if (this.score < 900) { return 35 ; } 
    else { return 30 ; } 
  ...
  public World onKeyEvent(String key) {
    ...
    if (this.words.activeScoreChecker(key)) {
      return new ZTypeWorld(this.words.checkActiveAndReduce(key).filterOutEmpties(), ticks, score + 10);
    }
...
class Utils {
   ...
   * this.rand ... -- ILoWord
   * Methods:
   * this.numToString ... -- String
   * this.stringAcc ... -- String
   * this.callAcc ... -- String
   * 
   * Methods of Fields:
...
class AllExamples {
  ...
  ILoWord list1rand = new ConsLoWord(new ActiveWord("circle", 2, 3), new ConsLoWord(this.random, this.mtLoWord));
  ...
  boolean testMakeScene(Tester t) {
    return t.checkExpect(this.mtWorld.makeScene(), this.mt.draw(ws1))
        &&
        t.checkExpect(this.list1World.makeScene(), this.list1.draw(ws1));
  }
   */
    ...
    return
        t.checkExpect(this.list1World.onTick(), 
            new ZTypeWorld(new ConsLoWord(new LevelWord("LEVEL 1", 300, 500, 1.5), 
                new ConsLoWord(new LevelWord ("Press tab to restart", 300, 520, .75), this.list1rand)), 1, 0));
  }
  ...
  /* boolean testMakeScene(Tester t) {
    return 
        t.checkExpect(this.mtWorld.makeScene(), this.mt.draw(ws1));
           
            new WorldScene(400, 600).placeImageXY(new EquilateralTriangleImage(15,
            OutlineMode.OUTLINE, Color.red), 200, 300).placeImageXY(new EquilateralTriangleImage(13,
                OutlineMode.SOLID, Color.white), 200, 300));
  ...
  boolean testLevelListHelp2(Tester t) {
    ...
    return t.checkExpect(list3.levelListHelp2(), false)
        ...
        && t.checkExpect(new ConsLoWord(new LevelWord("awfjfawjn", 1, 2, 0.5), new MtLoWord()).levelListHelp2(), true)
        //test for mt list
  ...
  boolean testReduce(Tester t) {
    return 
        //test for levelword
        t.checkExpect(new LevelWord("hola", 0, 0, 0.5).reduce("h"), (new ActiveWord("ola", 0, 0)))
        //test for inactive with wrong letter
        && t.checkExpect(new InactiveWord("awfjfawjn", 1, 2).reduce("h"), (new InactiveWord("awfjfawjn", 1, 2)))
        //test for inactive with right letter
        && t.checkExpect(new InactiveWord("awfjfawjn", 1, 2).reduce("a"), (new ActiveWord("wfjfawjn", 1, 2)))
